        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-3 text-xl font-bold text-white">IndigoRx</span>
            </div>
            <p className="text-sm text-gray-400 leading-relaxed mb-6">
              Streamlining patient care with innovative healthcare management solutions.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/faq" className="text-sm hover:text-green-400 transition-colors duration-300">
                  FAQ
                </Link>
              </li>
              <li>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-sm text-gray-400">
              © {currentYear} IndigoRx. All rights reserved.
            </p>
